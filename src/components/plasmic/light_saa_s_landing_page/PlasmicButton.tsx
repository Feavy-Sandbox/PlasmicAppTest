...
import * as sty from "./PlasmicButton.module.css"; // plasmic-import: gBTLQBxnRbDLcf/css
    ...
    >
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__y2F1S)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <ChevronRightIcon
                className={classNames(projectcss.all, sty.svg__vq4Mv)}
                role={"img"}
              />
            ),
